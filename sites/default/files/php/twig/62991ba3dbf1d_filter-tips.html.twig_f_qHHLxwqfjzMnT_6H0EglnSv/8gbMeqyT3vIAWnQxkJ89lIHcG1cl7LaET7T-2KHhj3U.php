...
class __TwigTemplate_a024a356a85b172db91b31d6f2dc66b5665e1b1f5a4ffeced22d7072976fcaf5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "/var/www/html/web_patrimoniosculturales/core/themes/classy/templates/content-edit/filter-tips.html.twig");
    }
